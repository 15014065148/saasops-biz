...
public class SysRoleService {
    ...
    public PageUtils queryListPage(SysRoleEntity sysRoleEntity, Integer pageNo, Integer pageSize) {
        PageHelper.startPage(pageNo, pageSize);
        List<SysRoleEntity> list = sysMapper.listSysRoleEntity(sysRoleEntity);
