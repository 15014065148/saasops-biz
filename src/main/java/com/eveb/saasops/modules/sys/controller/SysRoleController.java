...
public class SysRoleController extends AbstractController {
    ...
    public R queryListPage(@ModelAttribute SysRoleEntity sysRoleEntity, @RequestParam("pageNo") @NotNull Integer pageNo, @RequestParam("pageSize") @NotNull Integer pageSize) {
        return R.ok().put("page", sysRoleService.queryListPage(sysRoleEntity, pageNo, pageSize));
    }

    @GetMapping("/querySysRole")
    @RequiresPermissions("sys:role:list")
    public R list() {
        List<SysRoleEntity> menuList = sysRoleService.queryList(new HashMap<String, Object>());
    ...
    public R list(@RequestParam Map<String, Object> params) {
        ...
        PageUtils pageUtil = new PageUtils(list, total, query.getPageSize(), query.getPageNo());
